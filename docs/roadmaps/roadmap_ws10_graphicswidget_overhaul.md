...
canvas — node/edge scene items, selection, zoom/rotation, guides. Phase 1 (#250, a correctness/
hot-path/structural cleanup pass) and the #260 canvas-clear performance fix are both shipped —
see the Archive below. Everything else is open.
