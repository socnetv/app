/**
 * @file randscalefreeddialog.cpp
 * @brief Implements the RandScaleFreeDialog class for creating scale-free networks using the Barabási–Albert model in SocNetV.
