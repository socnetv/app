    ...
    ui(new Ui::DialogDataSetSelect)
{
    ...
    datasets_filenames
            ...
            << "Freeman_EIES_network_48actors_Acquaintanceship_at_time_1.dl"
            << "Freeman_EIES_network_48actors_Acquaintanceship_at_time_2.dl"
            ...
            << "Stephenson_Zelen_40_AIDS_patients_sex_contact.paj"
            << "Stephenson_Zelen_5actors_6edges_IC_test_dataset.paj"
            << "Stephenson_Zelen_Dunbar_Dunbar_Gelada_baboon_colony_H22a_IC.paj"
