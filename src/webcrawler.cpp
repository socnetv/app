/**
 * @file WebCrawler.cpp
 * @brief Implements the WebCrawler class for extracting and processing network data from web pages and online resources.
 * @details This file contains the logic for crawling web pages, extracting links, and generating network structures from online content.
